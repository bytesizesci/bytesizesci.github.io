...
Kristen J Sutton received her PhD in [Nutritional Biology](https://ggnb.ucdavis.edu) from the University of California, Davis in the lab of [Dr. Brian Bennett](https://www.ars.usda.gov/pacific-west-area/davis-ca/whnrc/omu/people/brian-j-bennett/bennett-lab/). Her PhD research used translational approaches in humans and Diversity Outbred mice to understand the dietary, lifestyle and multi-omic factors that influence plasma concentrations of trimethylamine n-oxide (TMAO), a metabolite linked to diet, the microbiome, and cardiometabolic diseases. 

Kristen is currently an NIH T32 Postdoctoral Fellow in the lab of [Dr. Joanne Cole](https://jcolelab.com/) in the [Department of Biomedical Informatics](https://medschool.cuanschutz.edu/dbmi) and the [Colorado Center for Precision Medicine](https://medschool.cuanschutz.edu/ccpm) at the [University of Colorado Anschutz Medical Campus](https://www.cuanschutz.edu/). During her postdoc, she is expanding her areas of expertise from nutrition science to statistical genetics and exercise science and is driven to become an independent investigator.

## Statistical Genetics using Large Biobanks
Genome-wide association studies (GWAS) look for associations between genetic markers and traits to help uncover the role of genetics on our health. Gene-trait associations can be leveraged to address many questions like evaluating a person's genetic risk for developing a disease using polygenic risk scores (PGS) and for inferring causal effects between exposures and outcomes via Mendelian randomization (MR). In Kristen's postdoc, she is applying these methods to ask questions linking behaviors like dietary intake and exercise levels to health outcomes mediated by factors like sex and genetics. This work is powered by large biobanks with genetic and phenotypic data (i.e., traits) such as the UK Biobank, All of Us Study, and Colorado Center for Personalized Medicine Biobank. 
...
The broad question that draws Kristen to scientific research is, "what makes you, you and me, me?" Kristen's current research addresses this question by looking at the role of the environment (via diet and physical activity) and genetics on biomarkers of health. In the future, Kristen can envision herself leading a team of researchers contributing to the precision health field by investigating healthy aging/longevity and identifying genetic (i.e. genome, trascriptome, metabolome) and environmental factors (i.e. diet, exposome, sleep, stress, exercise) that affect disease progression. Kristen's favorite part of the research process is the data analysis. As such, she is fluent in R, and skilled at the command line, using high performance computing clusters, cloud computing, and creating data visualizations.

## Hobbies
Kristen's hobbies include being active (lifting weights, running, hiking, cycling, playing tennis, skiing, golfing, gardening, and working on home improvement projects), making art (watercolor, ink drawings, print making, photography and throwing pottery), and spending time with her friends and family. Check out Kristen's art on Instagram, [@kjsketch](https://www.instagram.com/kjsketch/)).
